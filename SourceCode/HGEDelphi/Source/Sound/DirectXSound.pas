...
type
  D3DVALUE = DirectXTypes.D3DVALUE;
  {$EXTERNALSYM D3DVALUE}
  TD3DValue = DirectXTypes.TD3DValue;
  PD3DValue = DirectXTypes.PD3DValue;

  D3DCOLOR = DirectXTypes.D3DCOLOR;
  {$EXTERNALSYM D3DCOLOR}
  TD3DColor = DirectXTypes.TD3DColor;

  _D3DVECTOR = DirectXTypes._D3DVECTOR;
  {$EXTERNALSYM _D3DVECTOR}
  D3DVECTOR = DirectXTypes.D3DVECTOR;
  {$EXTERNALSYM D3DVECTOR}
  TD3DVector = DirectXTypes.TD3DVector;
  PD3DVector = DirectXTypes.PD3DVector;
...
type
  REFERENCE_TIME = DirectXTypes.REFERENCE_TIME;
  {$EXTERNALSYM REFERENCE_TIME}
  TReferenceTime = DirectXTypes.TReferenceTime;
  PReferenceTime = DirectXTypes.PReferenceTime;
