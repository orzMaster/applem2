...
type
  D3DVALUE = MyDXTypes.D3DVALUE;
  {$EXTERNALSYM D3DVALUE}
  TD3DValue = MyDXTypes.TD3DValue;
  PD3DValue = MyDXTypes.PD3DValue;

  D3DCOLOR = MyDXTypes.D3DCOLOR;
  {$EXTERNALSYM D3DCOLOR}
  TD3DColor = MyDXTypes.TD3DColor;

  _D3DVECTOR = MyDXTypes._D3DVECTOR;
  {$EXTERNALSYM _D3DVECTOR}
  D3DVECTOR = MyDXTypes.D3DVECTOR;
  {$EXTERNALSYM D3DVECTOR}
  TD3DVector = MyDXTypes.TD3DVector;
  PD3DVector = MyDXTypes.PD3DVector;
...
type
  REFERENCE_TIME = MyDXTypes.REFERENCE_TIME;
  {$EXTERNALSYM REFERENCE_TIME}
  TReferenceTime = MyDXTypes.TReferenceTime;
  PReferenceTime = MyDXTypes.PReferenceTime;
